...
# Opencv DNN
net_human = cv.dnn.readNet("/home/suyeoncha/catkin_ws/src/dnn_model/yolov4-tiny.weights", "/home/suyeoncha/catkin_ws/src/dnn_model/yolov4-tiny.cfg")
model = cv.dnn_DetectionModel(net_human)
...
while cv.waitKey(1) < 0:
    ...
    for (class_id, score, bbox) in zip(class_ids, scores, bboxes):
        ...
        cv.putText(frame, "{}".format(class_name), (500, 100), cv.FONT_HERSHEY_PLAIN, 2, (200, 0, 50), 2)
        cv.putText(frame, "{}mm".format(distance), (500, 150), cv.FONT_HERSHEY_PLAIN, 2, (200, 0, 50), 2)
